...
// enzyme: More flexibility, like shallow rendering (test components in isolation without children), also mimicking jQuery's API for DOM manipulation and traversal.
